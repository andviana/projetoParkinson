                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('tipo_atendimentos.update', $tipo_atendimento->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="denominacao" id="denominacao" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $tipo_atendimento->denominacao }}" required>
                        </div>
